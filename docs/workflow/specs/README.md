...
| [layer_7.md](layer_7.md) | 7 · Output assembly, validation, deduplication, and consolidation | `src/output_builder.py`, `src/validator.py`, `src/pottery_summary.py`, `src/site_norm.py`, `src/consolidation.py`, `src/hybrid_extractor.py` |
| [layer_8.md](layer_8.md) | 8 · Evaluation | `evaluation/evaluate.py`, `evaluation/evaluate_granular.py` |
