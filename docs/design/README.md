...
| File | What it covers |
|---|---|
| [design_notes.md](design_notes.md) | The key design decisions and trade-offs: anti-hallucination by verbatim quote, conservative consolidation, deterministic site resolution, graceful degradation, and more. |
