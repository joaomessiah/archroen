...
- **Metric:** field-level correctness, the percentage of field values judged correct (an exact or
  acceptable match to the reference), across five fields per finding (site, pottery, typology, start
  date, end date). This is the same metric defined in [../results.md](../results.md).
- **Scoring:** `evaluation/evaluate_granular.py`, run on each of the five runs.
- **Date:** 2026-06-28.
...
Field-level correctness across the five identical runs:
